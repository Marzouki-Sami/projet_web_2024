    ...
    try{
        ...
        if(count($result) == 0){
            ...
            if(count($result) != 0){
                ...
                echo "<p>Signer la pétition :</p>";
                echo "<form action='signer.php' method='post'>";
                echo "<input type='radio' name='signe' value='avec' id='avec' checked>";
                echo "<label for='avec'>Avec</label><br>";
                echo "<input type='radio' name='signe' value='contre' id='contre'>";
                echo "<label for='contre'>Contre</label><br>";
                //echo "<div class='form-outline'>";
                echo "<label class='form-label' for='commentaire'>commentaire:</label><br>";
                echo "<textarea  name='commentaire' id='commentaire' cols='50' rows='6'></textarea><br>";
                //echo "</div>";
                ...
                //boutton retour
                echo "<a href='petaff.php' class='btn btn-primary'>Retour</a>";
                echo "</div>";
                echo "</center>";
